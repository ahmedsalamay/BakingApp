...
package com.phantom.asalama.baking.models;
...
public class Baking implements Parcelable {
    ...
    protected Baking(Parcel in) {
        ...
        in.readList(this.ingredients, (com.phantom.asalama.baking.models.Ingredient.class.getClassLoader()));
        in.readList(this.steps, (com.phantom.asalama.baking.models.Step.class.getClassLoader()));
